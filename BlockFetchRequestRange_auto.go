...
func BlockFetchRequestRangeDummyImportUsage() error {return errors.New(reflect.TypeOf("").String())}
...
func (x *BlockFetchRequestRange) FromUntyped(fields_ interface{}) error {
  ...
  Lower, err := PointFromUntyped(fields[0])
  if err != nil {
    return err
  }
  x.Lower = Lower
  Upper, err := PointFromUntyped(fields[1])
  if err != nil {
    return err
  }
  x.Upper = Upper
