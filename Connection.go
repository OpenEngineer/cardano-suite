...
type Connection struct {
  ...
  BlockFetchEventEgress chan *Block
  debug bool
}
...
func NewConnection(magic int, host string, port string, state *BlockChainState, debug bool) (*Connection, error) {
  nodeId := HashFromString(host)
